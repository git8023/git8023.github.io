import { Dates, fns, Functions, Jsons, Validation } from '@hyong8023/tool-box';
...
export class Pipe<R = any> {
  ...
  static of<TR>(og: fns.OrGetter<TR>) {
    return new Pipe(og);
  }
  ...
  get isNil() {
    return Validation.isNil(this.val);
  }

  get isTruthy() {
    return Validation.notNil(this.val) && !!this.val;
  }
